...
export class MdbOnboardingService {
  ...
  @Output() readonly onboardingStart: EventEmitter<any> = new EventEmitter();
  @Output() readonly onboardingEnd: EventEmitter<any> = new EventEmitter();
  @Output() readonly onboardingOpen: EventEmitter<any> = new EventEmitter();
  @Output() readonly onboardingClose: EventEmitter<any> = new EventEmitter();
  @Output() readonly onboardingNext: EventEmitter<any> = new EventEmitter();
  @Output() readonly onboardingPrev: EventEmitter<any> = new EventEmitter();

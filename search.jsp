...
<body>
    ...
    <c:if test="${(listPBS.size()) == 0}">
        <div class="result-text">
            <h2 class="text text-center"><strong>No results for "${result}"</strong></h2>
        </div>
        <button style="display: block; margin: 16px auto" type="button" class="btn btn-lg btn-primary mt-2" onclick="location.href ='product' ">Shopping Now</button>
    </c:if>

    <c:if test="${(listPBS.size()) != 0}">

    <div class="result-text">
        <h2 class="text text-center">Result for "${result}"</h2>
    </div>
                ...
                <div class="css-treeview">
                    ...
                    <ul>
                        <li class="list-group-item">
                            <a style="height: auto" href="product">All Product</a>
                        </li>
                        <c:forEach items="${listC}" var="o">
                            <li class="list-group-item ${tagC == o.cId ? "active" : "" }">
                                <a style="height: auto " href="category?cid=${o.cId}">${o.cName}</a>
                            </li>
                        </c:forEach>
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="${p.img}" alt="" class="pro-image-front">
                                <img src="${p.img}" alt="" class="pro-image-back">
                            ...
                            <div class="item-info-product ">
                                ...
                                <div style="display: block" class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2 ${p.quantity == 0 ? "disable-outline" : ""}">
